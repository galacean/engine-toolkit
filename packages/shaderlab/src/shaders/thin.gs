    ...
    EditorProperties {
      ...
      Header("Base PBR") {
	   ...
	   Header("Thin Film") {
          ...
          // material_Eta3("iridescentIor",  Range(0,5, 0.1)) = 1.0;
           //material_Kappa3("k3",  Range(0, 10, 0.1)) = 1.0;
           material_Iridescence("Iridescence",  Range(0.0 , 1 , 0.01)) = 0.0;
           material_IridescenceThickness("iridescenceThickness",  Range(0.01 , 5 , 0.01)) = 0.07;
        }
