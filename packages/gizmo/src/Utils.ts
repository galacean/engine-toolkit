...
export class Utils {
  ...
  static init(engine: Engine) {
    ...
    // rotate material
    Utils.redArcMaterial = this._createUnlitMaterial(engine, Type.rotate, 1.0, 0.25, 0.25, 1.0);
    Utils.greenArcMaterial = this._createUnlitMaterial(engine, Type.rotate, 0.5, 0.8, 0.2, 1);
    Utils.blueArcMaterial = this._createUnlitMaterial(engine, Type.rotate, 0.3, 0.5, 1.0, 1);
